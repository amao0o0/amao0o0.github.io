...
You can also find my most up-to-date and complete list of publications on my [Google Scholar profile](https://scholar.google.com/citations?user=v8fXBnwAAAAJ&hl=en) (Citations:) :contentReference[oaicite:0]{index=0}
Pre-prints
---
* "Towards Spoken Mathematical Reasoning: Benchmarking Speech-based Models over Multi-faceted Math Problems" [📄 paper](https://arxiv.org/pdf/2505.15000) [💻 code & dataset](https://github.com/amao0o0/Spoken-MQA) \
**Chengwei Wei**, Bin Wang, Jung-jae Kim, Nancy F Chen \
arXiv preprint arXiv:2505.15000, 2025
...
---
* “CoinMath: Harnessing the Power of Coding Instruction for Math LLMs” [📄 paper](https://aclanthology.org/2025.findings-acl.44.pdf) [💻 code & dataset & model](https://github.com/amao0o0/CoinMath) \
**Chengwei Wei**, Bin Wang, Jung-jae Kim, Guimei Liu, Nancy F Chen \
ACL 2025 - Findings
* "Crowdsource, Crawl, or Generate? Creating SEA-VL, a Multicultural Vision-Language Dataset for Southeast Asia" [📄 paper](https://aclanthology.org/2025.acl-long.916.pdf) \
Samuel Cahyawijaya, Holy Lovenia, ..., **Chengwei Wei**, et al. \
ACL 2025
* "Advancing Singlish Understanding: Bridging the Gap with Datasets and Multimodal Models" [📄 paper](https://arxiv.org/pdf/2501.01034) [💻 code & dataset & model](https://github.com/AudioLLMs/Singlish) \
Bin Wang, Xunlong Zou, Shuo Sun, Wenyu Zhang, Yingxu He, Zhuohan Liu, **Chengwei Wei**, Nancy F Chen, AiTi Aw \
ASRU 2025
* "IFEval-Audio: Benchmarking Instruction-Following Capability in Audio-based Large Language Models" [📄 paper](https://arxiv.org/pdf/2505.16774) [💻 code & dataset](https://github.com/AudioLLMs/AudioBench) \
...
Journals
---
* "Efficient Human-Object-Interaction (EHOI) Detection via Interaction Label Coding and Conditional Decision" [📄 paper](https://www.sciencedirect.com/science/article/abs/pii/S1077314225001134) \
Tsung-Shan Yang, Yun-Cheng Wang, **Chengwei Wei**, Suya You, C-C Jay Kuo \
Computer Vision and Image Understanding, 2024
* "Word embedding dimension reduction via weakly-supervised feature selection" [📄 paper](https://www.nowpublishers.com/article/Details/SIP-20240046) \
